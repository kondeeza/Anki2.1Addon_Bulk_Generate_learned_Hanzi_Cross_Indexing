        ...
        if 'dic_number' in KanjiDefition_Result:
            if 'dic_ref' in KanjiDefition_Result['dic_number']:
                ...
                if isinstance(KanjiDefition_Result['dic_number']['dic_ref'], list):
                    KanjiDef_nelson_n = [elem['#text'] for elem in KanjiDefition_Result['dic_number']['dic_ref'] if
                    ...
                    KanjiDef_heisig = [elem['#text'] for elem in KanjiDefition_Result['dic_number']['dic_ref'] if
                                       elem['-dr_type'] == 'heisig']
                    if KanjiDef_heisig:
